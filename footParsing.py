...
def getdetail(info):
    ...
    print("Identifiant: "+info.id)
    print("Date: " + info.published)
    print (colorlib.ecrire(colorlib.ENCRE_JAUNE_VIOLET,u"Pays: ") + payslib.getpays(country))
    ...
    if score1 == '0' :
        ...
        print(colorlib.ecrire(colorlib.ENCRE_VERTE,team1 + ": ") + colorlib.ecrire(colorlib.ENCRE_JAUNE,score1)+ "-> " + ','.join(tmp))
    ...
    if score2 == '0' :
        ...
        print(colorlib.ecrire(colorlib.ENCRE_VERTE,team2 + ": ") + colorlib.ecrire(colorlib.ENCRE_JAUNE,score2)+ "-> " +','.join(tmp))
